  ...
  <div class="index">
    ...
    <div class="index-container">
      ...
      <div class="index-container-grid">
        <div class="block" v-for="i in 8" :key="i" @click="openRoom(i,'room')">
          <div class="pic">
            <img src="~@/assets/pic.webp" alt="">
            <div class="count">
    ...
    <div class="index-container">
      ...
      <!-- 房间块 -->
      <div class="index-container-grid">
        <div class="block" v-for="i in 8" :key="i" @click="openRoom(i,'chat')">
          <div class="pic">
            <img src="~@/assets/pic.webp" alt="">
            <div class="count">
              <i class="iconfont icon-users" /> 250.5万
          ...
          <div class="up">
            <img src="~@/assets/avatar1.gif" alt="">
            <div class="txt">
              <p class="name">LexBurner</p>
              <p title="小学生来啦！" class="desc">小学生来啦！</p>
              <p class="tag">王者荣耀</p>
